...
const Blog_card = (props) => {
  ...
  return (
    <div className={`w-11/12 rounded-xl p-2 flex rounded-x hover:shadow-xl hover:shadow-slate-600 transition duration-300 items-center justify-around bg-center my-4`}>
